...
def load_config() -> AppConfig:
    ...
    theme = ThemeConfig(
        ...
        panel_alpha=_bounded_float(parser.getfloat("theme", "panel_alpha", fallback=0.68), 0.0, 1.0),
        ...
        primary_text=parser.get("theme", "primary_text", fallback="#f8fafc"),
    ...
    for section in parser.sections():
        ...
        options.append(
            OptionConfig(
                ...
                icon=parser.get(section, "icon", fallback="play"),
